...
void main() {
  ...
  testWidgets('custom theme and reset Tests', (tester) async {
    ...
    manager.setTheme(
      light: ThemeData(brightness: Brightness.light, primaryColor: Colors.red),
      dark: ThemeData(brightness: Brightness.dark, primaryColor: Colors.red),
    );
    ...
    expect(
      manager.brightness,
      equals(Theme.of(context).brightness),
      reason: 'theme should reset to light but it did not.',
    );
    expect(
      Theme.of(context).primaryColor,
    ...
    expect(
      manager.lightTheme.primaryColor,
      equals(Colors.blue),
      reason: 'light theme should reset to default light theme but it did not.',
    );
    expect(
      manager.darkTheme.primaryColor,
      equals(Colors.blue),
      reason: 'dark theme should reset to default dark theme but it did not.',
    );
    expect(
      manager.mode.isLight,
      isTrue,
  ...
  testWidgets('Theme name tests', (tester) async {
    expect(
      AdaptiveThemeMode.light.modeName,
      equals('Light'),
      reason: 'light mode name is altered.',
    );
    expect(
      AdaptiveThemeMode.dark.modeName,
      equals('Dark'),
      reason: 'dark mode name is altered.',
    );
    expect(
      AdaptiveThemeMode.system.modeName,
      equals('System'),
  ...
  testWidgets('persist tests', (tester) async {
    ...
    expect(
      (await ThemePreferences.fromPrefs())!.mode.isDark,
      isTrue,
