...
void main() {
  ...
  testWidgets('CupertinoAdaptiveTheme load saved prefs test', (tester) async {
    ...
    await prefs.setString(
      CupertinoAdaptiveTheme.prefKey,
  ...
  testWidgets('AdaptiveThemeManager<CupertinoThemeData> retrieval tests', (
    ...
    expect(
      CupertinoAdaptiveTheme.maybeOf(context),
      isNotNull,
      reason:
  ...
  testWidgets('CupertinoAdaptiveTheme.getThemeMode() Tests', (tester) async {
    ...
    expect(
      CupertinoAdaptiveTheme.getThemeMode(),
      completes,
  ...
  testWidgets('theme, lightTheme, darkTheme and mode Tests', (tester) async {
    ...
    expect(
      manager.theme.brightness,
      equals(light.brightness),
      reason: 'manager.theme should be light but it is not.',
    );
    expect(
      manager.lightTheme.brightness,
      equals(light.brightness),
      reason: 'manager.lightTheme should be light but it is not.',
    );
    expect(
      manager.darkTheme.brightness,
      equals(dark.brightness),
  ...
  testWidgets('custom theme and reset Tests', (tester) async {
    ...
    expect(
      manager.brightness,
      equals(CupertinoTheme.of(context).brightness),
      reason: 'theme should reset to light but it did not.',
    );
    expect(
      CupertinoTheme.of(context).primaryColor,
